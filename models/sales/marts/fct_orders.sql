...
enriched_orders as (
    select
        ...
        {{ dbt_utils.generate_surrogate_key(['src_orders.sales_order_id', 'sales_order_detail_id']) }} as sales_reason_sk,
        ...
        {{ dbt_utils.generate_surrogate_key(['ship_to_address_id']) }} as address_sk,
